...
const ProductsForYou = () => {
  return (
    <div className="px-4 grid md:grid-cols-12 gap-2 max-w-containerLg mx-auto">
      {/* FIRST ANCHOR */}
      <div id="first-product" className="overflow-hidden">
        <motion.a
          whileHover="hover"
          initial="init"
          href="#"
          className="relative rounded-lg overflow-hidden md:min-h-0 block p-6"
        >
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2 md:max-w-[533px]">
              <h4 className="text-lg text-white font-semibold md:text-2xl">
          ...
          <div className="pt-[100%] md:pt-36" />
          <div className="relative">
            <motion.span
              variants={spanHoverVariant}
              className="flex items-center gap-2 text-xs text-white uppercase"
            >
              VER PRODUTO
            </motion.span>
            <motion.div
              variants={undelineHoverVariant}
              className="absolute rounded-lg -bottom-[6px] bg-white w-[1%] h-[0.5px] opacity-40"
            >
              {" "}
              aa
            </motion.div>
      ...
      <div
        id="second-product"
        className="bg-black md:min-h-[300px] rounded-lg relative overflow-hidden"
      >
        <a
          href="#"
          className="flex h-full justify-between p-6 md:p-8 overflow-hidden md:aboslute top-0 right-0 left-0 bottom-0"
        >
          <div className="flex flex-col justify-between h-full">
            <div>
              ...
              <p className="text-base text-white opacity-80 md:max-w-[260px]">
                <strong>Milhares</strong> de produtos,{" "}
                <strong>descontos de até 50%</strong> e cupons exclusivos.
              </p>
            </div>

            <div className="relative flex justify-center md:absolute top-0 right-0 bottom-0 md:w-[50%] lg:w-[40%]">
              <div className="absolute top-0 m-auto h-full z-[1]">
                <video
                  preload="auto"
                  autoPlay
                  playsInline
            ...
            <div>
              <span className="text-xs text-white">IR PARA C6 STORE</span>
            </div>
          </div>
        </a>
      </div>
      ...
      <div
        id="third-product"
        className="bg-gray-50 min-h-0 rounded-lg overflow-hidden"
      >
      ...
      <div
        id="fourty-product"
        className="bg-black bg-gradient-to-bl from-[#242424] to-black min-h-0 rounded-lg overflow-hidden"
      >
        <a href="#" className="relative block p-6">
          <h3 className="flex items-center gap-2 text-white h-5 mb-6">
            <svg
      ...
      <div
        id="eighty-product"
        className="relative overflow-hidden bg-gradient-to-br from-[#242424] to-black rounded-lg md:max-h-[300px]"
      >
        <a href="#" className="relative overflow-hidden block p-6 md:p-8">
          <div className="flex flex-col relative">
            ...
            <div className="pb-[44%] mb:pb-0"></div>
